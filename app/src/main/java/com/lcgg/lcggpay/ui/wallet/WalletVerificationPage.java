...
public class WalletVerificationPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPayableTo.setVisibility(View.GONE);
        txtAmount.setEnabled(true);

        if (valueActivity == "Add"){
            txtPay.setText("Add Amount");
        }
        else if (valueActivity == "Withdraw"){
            txtPay.setText("Withdraw Amount");
        }
        else if (valueActivity == "Transfer"){
            txtPay.setText("Transfer Amount");
            txtPayableTo.setVisibility(View.VISIBLE);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (valueActivity == "Add"){
                    txtPay.setText("Verify the amount to be added");
                }
                else{
                    if (valueActivity == "Transfer"){
                        txtPay.setText("Verify the amount to be transferred");
                    }
                    else if (valueActivity == "Withdraw"){
                        txtPay.setText("Verify the amount to be withdrawn");
                    }

                    if (Double.parseDouble(txtAmount.getText().toString()) > Double.parseDouble(txtWalletBal.getText().toString())){
                        btnSubmit.setEnabled(false);

                        AlertDialog.Builder builder = new AlertDialog.Builder(WalletVerificationPage.this, R.style.question_dialog);
                ...
                btnSubmit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (valueActivity == "Add"){
                            txtPay.setText("Confirmed Add Amount");
                        }
                        else if (valueActivity == "Withdraw") {
                            txtPay.setText("Confirmed Withdraw Amount");
                        }
                        else if (valueActivity == "Transfer") {
                             txtPay.setText("Confirmed Transfer Amount");
                         }
                        ...
                        mDatabase.child(mAuth.getUid()).child("Wallet").getRef().addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                                    ...
                                    if (valueActivity == "Add"){
                                        walletValue = "Add";
                                        newAmount = wallet.getAmount() + Double.parseDouble(txtAmount.getText().toString());
                                    }
                                    else if (valueActivity == "Withdraw") {
                                        walletValue = "Withdraw";
                                        newAmount = wallet.getAmount() - Double.parseDouble(txtAmount.getText().toString());
                                    }
                                    else if (valueActivity == "Transfer") {
                                        walletValue = "Transfer";
                                        newAmount = wallet.getAmount() - Double.parseDouble(txtAmount.getText().toString());
                                        ...
                                        mDatabase.child(txtPayableTo.getText().toString()).child("Wallet").getRef().addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                                                    ...
                                                    //Save transactions
                                                    mDatabase.child(txtPayableTo.getText().toString()).child("Wallet").child("Transactions").child(walletValue).child(mAuth.getUid()).child(txtConfirm.getText().toString()).child("transactionDate").setValue(strDate);
                                                    mDatabase.child(txtPayableTo.getText().toString()).child("Wallet").child("Transactions").child(walletValue).child(mAuth.getUid()).child(txtConfirm.getText().toString()).child("amount").setValue(txtAmount.getText().toString());
                                                }
                                            }
                                    ...
                                    //Save transactions
                                    mDatabase.child(mAuth.getUid()).child("Wallet").child("Transactions").child(walletValue).child(txtConfirm.getText().toString()).child("transactionDate").setValue(strDate);
                                    mDatabase.child(mAuth.getUid()).child("Wallet").child("Transactions").child(walletValue).child(txtConfirm.getText().toString()).child("amount").setValue(txtAmount.getText().toString());
                                }
                            }
